...
public class StickerPackListAdapter extends RecyclerView.Adapter<StickerPackListItemViewHolder> {
    ...
    public StickerPackListItemViewHolder onCreateViewHolder(@NonNull final ViewGroup viewGroup, final int i) {
        ...
        final View stickerPackRow = layoutInflater.inflate(stickers.app.cuppystickerapp.R.layout.sticker_packs_list_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final StickerPackListItemViewHolder viewHolder, final int index) {
        ...
        for (int i = 0; i < actualNumberOfStickersToShow; i++) {
            final SimpleDraweeView rowImage = (SimpleDraweeView) LayoutInflater.from(context).inflate(stickers.app.cuppystickerapp.R.layout.sticker_pack_list_item_image, viewHolder.imageRowView, false);
    ...
    private void setAddButtonAppearance(ImageView addButton, StickerPack pack) {
        if (pack.getIsWhitelisted()) {
            addButton.setImageResource(stickers.app.cuppystickerapp.R.drawable.sticker_3rdparty_added);
            ...
            addButton.setImageResource(stickers.app.cuppystickerapp.R.drawable.sticker_3rdparty_add);
