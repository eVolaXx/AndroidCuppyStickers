...
public class StickerPackListActivity extends AddStickerPackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(stickers.app.cuppystickerapp.R.layout.activity_sticker_pack_list);
        packRecyclerView = findViewById(stickers.app.cuppystickerapp.R.id.sticker_pack_list);
    ...
    private void recalculateColumnCount() {
        final int previewSize = getResources().getDimensionPixelSize(stickers.app.cuppystickerapp.R.dimen.sticker_pack_list_item_preview_image_size);
